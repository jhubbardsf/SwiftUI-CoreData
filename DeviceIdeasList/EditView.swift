        ...
        VStack {
            VStack {
                TextField("Idea title", text: $updatedIdeaTitle)
                    ...
                    .onAppear {
                        ...
                        self.updatedIdeaTitle = self.DeviceIdea.deviceTitle ?? ""
                }
                ...
                TextField("Idea description", text: $updatedIdeaDescription)
                    ...
                    .onAppear {
                        // ℹ️ Set the text field's initial value when it appears
                        self.updatedIdeaDescription = self.DeviceIdea.deviceDescription ?? ""
                }
            }
            ...
            VStack {
                Button(action: ({
                    ...
                    self.DeviceIdea.deviceTitle = self.updatedIdeaTitle
                    self.DeviceIdea.deviceDescription = self.updatedIdeaDescription
